...
// Represents the tab when processing option two of the first team.
public class FirstTeamOptionTwo extends JFrame {
    ...
    public FirstTeamOptionTwo(Team t, TradeList tl) {
